...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Logistics', path: '/logistics', entity: 'logistics', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Outlets', path: '/outlets', entity: 'outlet', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Rentals', path: '/rentals', entity: 'rental', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Tools', path: '/tools', entity: 'tool', service: AccessServiceEnum.PROJECT, icon: FiBox },
