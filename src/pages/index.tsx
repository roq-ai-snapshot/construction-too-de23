  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental v1 - Your one-stop solution for all your construction tool needs. Rent tools from multiple outlets, anytime, anywhere."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental v1 - Your one-stop solution for all your construction tool needs. Rent tools from multiple outlets, anytime, anywhere.`}
            </Text>
            <Box
