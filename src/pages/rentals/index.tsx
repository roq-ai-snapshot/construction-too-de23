...
export function RentalListPage(props: RentalListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRentals({
        relations: ['user', 'tool', 'logistics.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('tool', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('logistics', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'logistics',
          header: 'Logistics',
          accessorKey: 'logistics',
          cell: ({ row: { original: record } }: any) => record?._count?.logistics,
        }
      : null,
